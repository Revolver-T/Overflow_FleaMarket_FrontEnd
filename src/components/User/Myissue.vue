      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="商品售价" prop="price">
            <el-input v-model.number="productData.price" placeholder="请填写商品售价"></el-input>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="8" :offset="1">
...
<script>
  ...
  export default{
    ...
    created() {
      ...
      this.productData.createTime = date;
      this.createTime = this.productData.createTime;
    ...
    methods:{
      ...
      subProForm(){
        ...
        this.$axios.post('/product/insertProductByUser', {
          ...
          createTime: this.productData.createTime,
