  ...
  <div class="bodyd">
    ...
    <el-row class="containerDetails">
      <el-col :span="12" :offset="6">
        <div class="pro">
          <!-- 商品统计模块 -->
          <div class="pdtime"><span>发布于 : {{data.createTime}}</span> <span style="margin-left: 20px;">浏览人次：{{data.clicks}}次</span></div>
          <!-- 商品区域 -->
          <el-row>
            <!-- 商品图片 -->
            <el-col :span="10">
              <div class="pimg"> <img :src="imgblur" alt="" max-height="100%"> </div>
              <div class="pimgs">
            ...
            <el-col :span="14" class="pdetails">
              ...
              <table class="pd">
                <tr> <td>价格</td>     <td class="pdprice">¥ {{data.price}}                 </td> </tr>
          ...
          <div class="leaveMessage" v-if="this.User !== ''">
            <div class="meimg"><img :src="User.userImg" alt=""></div>
    ...
    <el-dialog
            ...
            <el-col :span="20" :offset="1">
              <el-form ref="userbuy" :model="userbuy" :rules="rules"  label-width="100px">
                ...
                <el-form-item label="联系方式" prop="phone">
                  <el-input v-model.number="userbuy.phone"></el-input>
                </el-form-item>
      ...
      <el-dialog
        ...
        <el-row class="orderInfo">
          ...
          <el-col :span="5"> 订单状态：{{order.payed===1?'未支付':'已支付'}} </el-col>
        ...
        <div class="productInfo">
          <el-row v-for="item in order.products" :key="item.id">
            ...
            <el-col :span="6" class="infoTop"> <p>¥{{item.price}}</p> </el-col>
          </el-row>
        </div>
        ...
        <el-row class="btnClick">
          ...
          <el-col :span="3">
            <el-button @click="deletePay(order.orderId)">取消订单</el-button>
          </el-col>
        </el-row>
      </el-dialog>
    </el-dialog>
    ...
    methods: {
      ...
      loadcomments(){
        ...
        this.$axios.get('/product/selectCommentById', {
          ...
          this.updataProductComments(res.data.length);
          this.selectLoveById();
          // this.test();
        });
      },
      //修改商品评论数量
      updataProductComments(length){
      ...
      createOrder(){
        ...
        this.$axios.post('/order/insertOrderByOrder', {
          receiver: this.userbuy.username,//收货人
          receiverPhone: this.userbuy.phone,//收货人联系方式
          receiverMail: this.userbuy.mail,//收货人邮箱
          address: this.userbuy.address,//收货地址
          remark: this.remark,//订单备注
          createPersonId: this.User.id,//创建人编号
          createTime: moment().format('YYYY-MM-DD HH:mm:ss'),//创建时间
          productCount: 1,
          productId: [this.data.id],
          productTotal: this.data.price,
          orderId:'233'
        }).then(res => {
          ...
          type: 'warning'
            ...
            this.$axios.post("/order/updateOrderByOid",{
              ...
              if(res.data === 1){
                ...
                //跳转支付界面，进行沙箱模拟支付
                setTimeout(res => {
                  window.location.href = "http://localhost:1024/alipay/pay?subject="+order.remark+"&traceNo="+order.orderId+"&totalAmount="+order.productTotal;
                },500);
                //跳转我的页面
      ...
      test(){
        console.log(this.comments.time)
      },
      //统计点击量
      clickNum(){
        //判断数据库中是否存在当前日期
